...
from api.schemas.extension.errors import get_length_error_message, get_string_error_messages, \
...
class UserEditSchema(CommonSchema):
    __users_repository: IUserRepository
    __roles_repository: IRoleRepository

    def __init__(self, user_id: str, users_repository=Provide[ApplicationContainer.repositories.users_repository],
                 roles_repository=Provide[ApplicationContainer.repositories.roles_repository], *args, **kwargs):
        super().__init__(schema_class_to_map=None, *args, **kwargs)
    ...
    def validate_unique_email(self, email):
        ...
        if email is not None:
            if not self.__users_repository.can_change_email(self.__user_id, email):
